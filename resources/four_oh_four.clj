        ...
        [:article
         ...
         [:section
          ...
          [:dl
           ...
           [:dt [:a.four-oh-four-link {:href "ideas.html"} "Ideas"]] [:dd "A more in-depth disscussion of the ideas the Speculoos experiment tests."]
           ...
           [:dt [:a.four-oh-four-link {:href "diff.html"} [:code "(diff spec.alpha speculoos)"]]] [:dd "Side-by-side comaparison of " [:code "spec.alpha"] " and Speculoos."]
           ...
           [:dt [:a.four-oh-four-link {:href "source.html"} "Source"]] [:dd "Source code repository, dependency, compatability, installation, and release information."]
