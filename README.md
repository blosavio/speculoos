...
;;      :value
;;        [#object
;;          [clojure.core$int_QMARK_ 0x280b0df9
;;           &quot;clojure.core$int_QMARK_@280b0df9&quot;]
;;         #object
;;          [clojure.core$string_QMARK___5494
;;           0xc41709a
;;           &quot;clojure.core$string_QMARK___5494@c41709a&quot;]
;;         #object
;;          [clojure.core$ratio_QMARK_ 0x72d3cdb
;;           &quot;clojure.core$ratio_QMARK_@72d3cdb&quot;]]}
;;     {:path [0],
;;      :value
;;        #object
;;         [clojure.core$int_QMARK_ 0x280b0df9
...
;;        #object
;;         [clojure.core$ratio_QMARK_ 0x72d3cdb
;;          &quot;clojure.core$ratio_QMARK_@72d3cdb&quot;]}]</code></pre><p>…or nested in a map…</p><pre><code>(all-paths {:x int?, :y string?, :z {:w ratio?}})
;; =&gt; [{:path [],
;;      :value
;;        {:x
;;           #object
...
;;     {:path [0], :value 42}
;;     {:path [1], :value &quot;abc&quot;}
;;     {:path [2], :value 22/7}]</code><br /><br /><code>;; specification vector containing one predicate</code><br /><code>(all-paths [int?])
;; =&gt; [{:path [],
;;      :value
;;        [#object
;;          [clojure.core$int_QMARK_
...
;;         [clojure.core$int_QMARK_
;;          0x280b0df9
;;          &quot;clojure.core$int_QMARK_@280b0df9&quot;]}]</code></pre><p>After discarding the root collections at path <code>[]</code> we find the only scalar+predicate pair at path <code>[0]</code>, and that&apos;s the only pair that <code>validate-scalars</code> looks at.</p><pre><code>(validate-scalars [42 &quot;abc&quot; 22/7]
&nbsp;                 [int?])
;; =&gt; [{:datum 42,
;;      :path [0],
;;      :predicate
...
;; =&gt; [{:path [],
;;      :value
;;        [#object [clojure.core$int_QMARK_ 0x280b0df9
;;                  &quot;clojure.core$int_QMARK_@280b0df9&quot;]
;;         #object
;;          [clojure.core$string_QMARK___5494 0xc41709a
;;           &quot;clojure.core$string_QMARK___5494@c41709a&quot;]
;;         #object
;;          [clojure.core$ratio_QMARK_ 0x72d3cdb
;;           &quot;clojure.core$ratio_QMARK_@72d3cdb&quot;]]}
...
;;      :value
;;        {:s #object
;;             [clojure.core$decimal_QMARK_ 0x40429f12
;;              &quot;clojure.core$decimal_QMARK_@40429f12&quot;],
;;         :x #object
;;             [clojure.core$int_QMARK_ 0x280b0df9
;;              &quot;clojure.core$int_QMARK_@280b0df9&quot;]}}
;;     {:path [:x],
...
;;            &quot;clojure.core$string_QMARK___5494@c41709a&quot;]
;;          [#object
;;            [clojure.core$char_QMARK___5492 0x5286aa41
;;             &quot;clojure.core$char_QMARK___5492@5286aa41&quot;]]]]}
;;     {:path [0],
;;      :value #object [clojure.core$int_QMARK_ 0x280b0df9
;;                      &quot;clojure.core$int_QMARK_@280b0df9&quot;]}
;;     {:path [1],
;;      :value
;;        [#object
...
;;      :value #object
;;              [clojure.core$char_QMARK___5492 0x5286aa41
;;               &quot;clojure.core$char_QMARK___5492@5286aa41&quot;]}]</code></pre><p>Again, six total elements: three vectors that will be ignored, plus three predicates. When we validate…</p><pre><code>(validate-scalars [42 [&quot;abc&quot; [22/7]]]
&nbsp;                 [int? [string? [char?]]])
;; =&gt; [{:datum 42,
;;      :path [0],
;;      :predicate
...
;;      :predicate
;;        #object
;;         [clojure.core$char_QMARK___5492
;;          0x5286aa41
;;          &quot;clojure.core$char_QMARK___5492@5286aa41&quot;],
...
;;           &quot;readmoi_generator$len_3_QMARK_@f9ad4c9&quot;]
;;         [#object
;;           [readmoi_generator$len_2_QMARK_
;;            0x62060983
;;            &quot;readmoi_generator$len_2_QMARK_@62060983&quot;]]]}
;;     {:path [0],
;;      :value
;;        #object
;;         [readmoi_generator$len_3_QMARK_
...
;; =&gt; [{:path [],
;;      :value
;;        [#object [readmoi_generator$len_3_QMARK_ 0xf9ad4c9
;;                  &quot;readmoi_generator$len_3_QMARK_@f9ad4c9&quot;]
;;         [#object
;;           [readmoi_generator$len_2_QMARK_ 0x62060983
;;            &quot;readmoi_generator$len_2_QMARK_@62060983&quot;]
;;          [#object
;;            [readmoi_generator$len_1_QMARK_ 0x622314c2
;;             &quot;readmoi_generator$len_1_QMARK_@622314c2&quot;]]]]}
;;     {:path [0],
;;      :value #object
;;              [readmoi_generator$len_3_QMARK_ 0xf9ad4c9
;;               &quot;readmoi_generator$len_3_QMARK_@f9ad4c9&quot;]}
;;     {:path [1],
;;      :value
;;        [#object
...
;;      :value #object
;;              [readmoi_generator$len_1_QMARK_ 0x622314c2
;;               &quot;readmoi_generator$len_1_QMARK_@622314c2&quot;]}]</code></pre><p>Six elements: three collections, three predicates.</p></li><li><p>Remove scalar elements from the data, keeping only the collection elements.</p><pre><code>[{:path [], :value [42 [&quot;abc&quot; [22/7]]]}
&nbsp;{:path [1], :value [&quot;abc&quot; [22/7]]}
...
;;      :predicate
;;        #object
;;         [readmoi_generator$len_1_QMARK_
;;          0x622314c2
;;          &quot;readmoi_generator$len_1_QMARK_@622314c2&quot;],
...
;;      :predicate
;;        #object
;;         [clojure.core$map_QMARK___5496 0xc7a1db6
;;          &quot;clojure.core$map_QMARK___5496@c7a1db6&quot;],
...
;;         [clojure.core$map_QMARK___5496
;;          0xc7a1db6
;;          &quot;clojure.core$map_QMARK___5496@c7a1db6&quot;]}]</code></pre><p>Discard all non-collection elements in the data…</p><pre><code>[{:path [],:value {:x 42, :y {:z &quot;abc&quot;}}}
...
;;      :path-datum [],
;;      :path-predicate [:y],
;;      :predicate #object [clojure.core$map_QMARK___5496 0xc7a1db6
;;                          &quot;clojure.core$map_QMARK___5496@c7a1db6&quot;],
...
;;      :predicate
;;        #object
;;         [clojure.core$set_QMARK_ 0x47893392
;;          &quot;clojure.core$set_QMARK_@47893392&quot;],
...
;;      :path-datum [],
;;      :path-predicate [:is-a-map?],
;;      :predicate #object [clojure.core$vector_QMARK___5498 0x54d4c35f
;;                          &quot;clojure.core$vector_QMARK___5498@54d4c35f&quot;],
...
;;      :path-datum [],
;;      :path-predicate [2],
;;      :predicate #object [clojure.core$list_QMARK_ 0x471a163a
;;                          &quot;clojure.core$list_QMARK_@471a163a&quot;],
;;      :valid? false}
;;     {:datum [42],
;;      :ordinal-path-datum [],
;;      :path-datum [],
;;      :path-predicate [3],
;;      :predicate #object [clojure.core$set_QMARK_ 0x47893392
;;                          &quot;clojure.core$set_QMARK_@47893392&quot;],
;;      :valid? false}
;;     {:datum [42],
;;      :ordinal-path-datum [],
;;      :path-datum [],
;;      :path-predicate [4],
;;      :predicate #object [clojure.core$coll_QMARK_ 0x2290ca46
;;                          &quot;clojure.core$coll_QMARK_@2290ca46&quot;],
...
;;           &quot;clojure.core$coll_QMARK_@2290ca46&quot;]
;;         #object
;;          [clojure.core$vector_QMARK___5498
;;           0x54d4c35f
;;           &quot;clojure.core$vector_QMARK___5498@54d4c35f&quot;]
;;         {:foo
;;            #object
...
;;         [clojure.core$map_QMARK___5496
;;          0xc7a1db6
;;          &quot;clojure.core$map_QMARK___5496@c7a1db6&quot;]}]</code></pre><p>Next remove all non-collection elements from the data.</p><pre><code>[{:path [], :value [{:y &quot;abc&quot;}]}
...
;;      :path-predicate [0],
;;      :predicate
;;        #object [clojure.core$coll_QMARK_ 0x2290ca46
;;                 &quot;clojure.core$coll_QMARK_@2290ca46&quot;],
;;      :valid? true}
;;     {:datum [42 {:y &quot;abc&quot;}],
;;      :ordinal-path-datum [],
...
;;      :predicate
;;        #object
;;         [clojure.core$vector_QMARK___5498 0x54d4c35f
;;          &quot;clojure.core$vector_QMARK___5498@54d4c35f&quot;],
;;      :valid? true}
;;     {:datum {:y &quot;abc&quot;},
;;      :ordinal-path-datum [0],
...
;;              &quot;clojure.core$map_QMARK___5496@c7a1db6&quot;]}
;;         (#object
;;           [clojure.core$list_QMARK_ 0x471a163a
;;            &quot;clojure.core$list_QMARK_@471a163a&quot;])
;;         #{#object
;;            [clojure.core$set_QMARK_ 0x47893392
;;             &quot;clojure.core$set_QMARK_@47893392&quot;]}]}
...
;;      :value #object
;;              [clojure.core$set_QMARK_ 0x47893392
;;               &quot;clojure.core$set_QMARK_@47893392&quot;]}]</code></pre><p>Next, we retain the path elements of the data&apos;s second-level collections only…</p><pre><code>[{:path [0], :value {}}
&nbsp;{:path [1], :value ()}
...
;;      :path-datum [],
;;      :path-predicate [2],
;;      :predicate #object [clojure.core$sequential_QMARK_ 0x50912319
;;                          &quot;clojure.core$sequential_QMARK_@50912319&quot;],
;;      :valid? true}
;;     {:datum (33),
;;      :ordinal-path-datum [1],
;;      :path-datum [2],
;;      :path-predicate [3 0],
;;      :predicate #object [clojure.core$list_QMARK_ 0x471a163a &quot;clojure.core$list_QMARK_@471a163a&quot;],
;;      :valid? true}
;;     {:datum [{:a 11} 22 (33) 44 #{55}],
;;      :ordinal-path-datum [],
;;      :path-datum [],
;;      :path-predicate [4],
;;      :predicate #object [clojure.core$coll_QMARK_ 0x2290ca46 &quot;clojure.core$coll_QMARK_@2290ca46&quot;],
;;      :valid? true}
;;     {:datum #{55},
;;      :ordinal-path-datum [2],
;;      :path-datum [4],
;;      :path-predicate [5
;;                       #object [clojure.core$set_QMARK_ 0x47893392 &quot;clojure.core$set_QMARK_@47893392&quot;]],
;;      :predicate #object [clojure.core$set_QMARK_ 0x47893392 &quot;clojure.core$set_QMARK_@47893392&quot;],
;;      :valid? true}
;;     {:datum [{:a 11} 22 (33) 44 #{55}],
;;      :ordinal-path-datum [],
;;      :path-datum [],
;;      :path-predicate [6],
;;      :predicate #object [clojure.core$any_QMARK_ 0x73ca241d &quot;clojure.core$any_QMARK_@73ca241d&quot;],
...
;;      :predicate
;;        #object
;;         [readmoi_generator$len_3_QMARK_ 0x238015c9
;;          &quot;readmoi_generator$len_3_QMARK_@238015c9&quot;],
;;      :valid? false}
;;     {:datum [&quot;abc&quot; [22/7]],
;;      :ordinal-path-datum [0],
;;      :path-datum [1],
...
;;      :predicate
;;        #object
;;         [readmoi_generator$len_2_QMARK_ 0x9236b61
;;          &quot;readmoi_generator$len_2_QMARK_@9236b61&quot;],
;;      :valid? true}
;;     {:datum [22/7],
;;      :ordinal-path-datum [0 0],
;;      :path-datum [1 1],
...
;;      :predicate
;;        #object
;;         [readmoi_generator$len_1_QMARK_ 0x48701496
;;          &quot;readmoi_generator$len_1_QMARK_@48701496&quot;],
...
;;          0x4fdfa676
;;          &quot;clojure.core$symbol_QMARK_@4fdfa676&quot;],
...
;;      :path-datum [],
;;      :path-predicate [0],
;;      :predicate #object [readmoi_generator$count_3_QMARK_ 0x532a6dec
;;                          &quot;readmoi_generator$count_3_QMARK_@532a6dec&quot;],
...
;;      :predicate
;;        #object
;;         [readmoi_generator$count_3_QMARK_ 0x532a6dec
;;          &quot;readmoi_generator$count_3_QMARK_@532a6dec&quot;],
...
;;      :fn-spec-type :speculoos/argument,
;;      :path [0],
;;      :predicate #object [clojure.core$int_QMARK_ 0x280b0df9
;;                          &quot;clojure.core$int_QMARK_@280b0df9&quot;],
;;      :valid? false}
;;     {:datum 22/7,
;;      :fn-spec-type :speculoos/argument,
...
;;          0x3d4d3fe7
;;          &quot;clojure.core$boolean_QMARK_@3d4d3fe7&quot;],
...
;;      :predicate
;;        #object
;;         [clojure.core$boolean_QMARK_ 0x3d4d3fe7
;;          &quot;clojure.core$boolean_QMARK_@3d4d3fe7&quot;],
;;      :valid? false}
;;     {:datum [1 20 300 321],
;;      :ordinal-path-datum [],
...
;;      :fn-spec-type :speculoos/argument,
;;      :path [0],
;;      :predicate #object [clojure.core$string_QMARK___5494 0xc41709a
;;                          &quot;clojure.core$string_QMARK___5494@c41709a&quot;],
;;      :valid? false}
;;     {:datum 300,
;;      :fn-spec-type :speculoos/argument,
;;      :path [2],
;;      :predicate #object [clojure.core$symbol_QMARK_ 0x4fdfa676
;;                          &quot;clojure.core$symbol_QMARK_@4fdfa676&quot;],
;;      :valid? false}
;;     {:datum [1 20 300],
;;      :fn-spec-type :speculoos/argument,
...
;;      :path-datum [],
;;      :path-predicate [0],
;;      :predicate #object [readmoi_generator$length_2_QMARK_ 0x4ba0ab66
;;                          &quot;readmoi_generator$length_2_QMARK_@4ba0ab66&quot;],
;;      :valid? false}
;;     {:datum 1,
;;      :fn-spec-type :speculoos/return,
;;      :path [0],
;;      :predicate #object [clojure.core$char_QMARK___5492 0x5286aa41
;;                          &quot;clojure.core$char_QMARK___5492@5286aa41&quot;],
;;      :valid? false}
;;     {:datum 321,
;;      :fn-spec-type :speculoos/return,
;;      :path [3],
;;      :predicate #object [clojure.core$boolean_QMARK_ 0x3d4d3fe7
;;                          &quot;clojure.core$boolean_QMARK_@3d4d3fe7&quot;],
;;      :valid? false}
;;     {:datum [1 20 300 321],
;;      :fn-spec-type :speculoos/return,
...
;;      :path-argument [0],
;;      :path-return [],
;;      :relationship-fn #object
;;                        [readmoi_generator$same_length_QMARK_ 0x1abf7c9d
;;                         &quot;readmoi_generator$same_length_QMARK_@1abf7c9d&quot;],
...
;;      :path-return [],
;;      :relationship-fn
;;        #object [readmoi_generator$same_elements_QMARK_ 0x68c4f321
;;                 &quot;readmoi_generator$same_elements_QMARK_@68c4f321&quot;],
;;      :valid? false}
;;     {:datum-argument [11 22 33 44 55],
;;      :datum-return [11 22 33 44 55 9999],
;;      :fn-spec-type :speculoos/argument-return-relationship,
...
;;      :path-return [],
;;      :relationship-fn #object
;;                        [readmoi_generator$reversed_QMARK_ 0x3894400
;;                         &quot;readmoi_generator$reversed_QMARK_@3894400&quot;],
...
;;      :path-argument [0],
;;      :path-return nil,
;;      :relationship-fn #object [clojure.core$_LT_ 0x601dbb87
;;                                &quot;clojure.core$_LT_@601dbb87&quot;],
;;      :valid? false}
;;     {:datum-argument 99,
;;      :datum-return -99,
;;      :fn-spec-type :speculoos/argument-return-relationship,
...
;;      :path-return nil,
;;      :relationship-fn
;;        #object [readmoi_generator$plus_one_QMARK_ 0x487bb6d0
;;                 &quot;readmoi_generator$plus_one_QMARK_@487bb6d0&quot;],
...
;;      :relationship-fn
;;        #object
;;         [clojure.core$_EQ_ 0x412b580d
;;          &quot;clojure.core$_EQ_@412b580d&quot;],
;;      :valid? false}
;;     {:datum-argument
;;        &quot;aragorn@sonofarath.org&quot;,
...
;;      :fn-spec-type :speculoos/argument,
;;      :path [0 2],
;;      :predicate #object [clojure.core$decimal_QMARK_ 0x40429f12
;;                          &quot;clojure.core$decimal_QMARK_@40429f12&quot;],
;;      :valid? false}
...
;;      :path-return [],
;;      :relationship-fn
;;        #object [readmoi_generator$reversed_QMARK_ 0x3894400
;;                 &quot;readmoi_generator$reversed_QMARK_@3894400&quot;],
...
;; =&gt; #:speculoos{:arg-collection-spec
;;                  [[#object [clojure.core$list_QMARK_ 0x471a163a
;;                             &quot;clojure.core$list_QMARK_@471a163a&quot;]]],
;;                :arg-scalar-spec [[#object [clojure.core$any_QMARK_ 0x73ca241d
;;                                            &quot;clojure.core$any_QMARK_@73ca241d&quot;]
;;                                   #object [clojure.core$any_QMARK_ 0x73ca241d
;;                                            &quot;clojure.core$any_QMARK_@73ca241d&quot;]
;;                                   #object
;;                                    [clojure.core$decimal_QMARK_ 0x40429f12
;;                                     &quot;clojure.core$decimal_QMARK_@40429f12&quot;]]],
...
;;                   #object [clojure.core$any_QMARK_ 0x73ca241d
;;                            &quot;clojure.core$any_QMARK_@73ca241d&quot;]
;;                   #object [clojure.core$string_QMARK___5494 0xc41709a
;;                            &quot;clojure.core$string_QMARK___5494@c41709a&quot;]]}</code></pre><p>We confirm that all five function specifications in <code>broken-reverse</code>&apos;s metadata. <code>validate-fn</code> can now find those specifications.</p><p>Finally, we validate <code>broken-reverse</code>.</p><pre><code>(validate-fn broken-reverse [11 22 33 44 55])
;; =&gt; ({:datum 33,
;;      :fn-spec-type :speculoos/argument,
;;      :path [0 2],
;;      :predicate
...
;;      :relationship-fn
;;        #object
;;         [readmoi_generator$reversed_QMARK_
;;          0x3894400
;;          &quot;readmoi_generator$reversed_QMARK_@3894400&quot;],
...
;;          0x549426d8
;;          &quot;clojure.core$keyword_QMARK_@549426d8&quot;],
...
;;         [clojure.core$ratio_QMARK_
;;          0x72d3cdb
;;          &quot;clojure.core$ratio_QMARK_@72d3cdb&quot;]})</code></pre><p>It is especially helpful for <a href="#troubleshooting">diagnosing surprising results</a>. Just because we put a predicate into the scalar specification doesn&apos;t force validation of a scalar that doesn&apos;t exist.</p><pre><code>(predicates-without-scalars [42 &quot;abc&quot;]
&nbsp;                           [int? [string? ratio?]])
;; =&gt; ({:path [1 0],
;;      :value
;;        #object
...
;;         [clojure.core$ratio_QMARK_
;;          0x72d3cdb
;;          &quot;clojure.core$ratio_QMARK_@72d3cdb&quot;]})</code></pre><p>Now we can see two un-paired predicates. <code>ratio?</code> simply doesn&apos;t have a scalar to pair with, and <code>string?</code> doesn&apos;t share a path with <code>&quot;abc&quot;</code> so it wasn&apos;t used during validation.</p><p>It&apos;s not difficult to neglect a predicate for a nested element within a collection specification, so Speculoos offers analogous utilities to highlight those possible issues.</p><pre><code>(collections-without-predicates [11 [22 {:a 33}]]
&nbsp;                               [vector? [{:is-a-map? map?}]])
...
;;      :predicate
;;        #object
;;         [readmoi_generator$greater_than_50_QMARK_
;;          0x506b8505
;;          &quot;readmoi_generator$greater_than_50_QMARK_@506b8505&quot;],
...
;; =&gt; [{:datum &quot;F1Q5&quot;,
;;      :path [0],
;;      :predicate #object [readmoi_generator$re_pred 0x6faea62f
;;                          &quot;readmoi_generator$re_pred@6faea62f&quot;],
;;      :valid? &quot;F1Q5&quot;}
;;     {:datum &quot;F2QQ&quot;,
;;      :path [1],
;;      :predicate #object [readmoi_generator$re_pred 0x6faea62f
;;                          &quot;readmoi_generator$re_pred@6faea62f&quot;],
;;      :valid? nil}]</code></pre><p>Speculoos considers regexes in a scalar specification as predicates, so we can simply jam them in there.</p><pre><code>(valid-scalars? [&quot;A1B2&quot; &quot;CDEF&quot;]
&nbsp;               [#&quot;(\w\d){2}&quot; #&quot;\w{4}&quot;])
...
;;      :predicate
;;        #object
;;         [clojure.core$keyword_QMARK_ 0x549426d8
;;          &quot;clojure.core$keyword_QMARK_@549426d8&quot;],
;;      :valid? true}
;;     {:datum 22/7,
;;      :path [2],
...
;;      :predicate
;;        #object
;;         [clojure.core$qualified_keyword_QMARK_ 0x1151580c
;;          &quot;clojure.core$qualified_keyword_QMARK_@1151580c&quot;],
;;      :valid? false}
;;     {:datums-set #{:chocolate},
;;      :path [],
;;      :predicate #object
